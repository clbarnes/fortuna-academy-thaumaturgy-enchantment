...
The core mechanics of _Fortuna's_ are explained in https://evilhat.com/product/fate-condensed/[Evil Hat Games' Fate Condensed], for which a System Reference Document is available https://fate-srd.com/fate-condensed[here].
...
Additionally, they have a grade in each of their Classes at the Academy!
